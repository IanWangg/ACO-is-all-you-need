...
parser.add_argument('--action-seq-length', default=10, type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    wandb.init(project="aco-carla", entity="yiranwang1027")
    args.gpu = gpu
    ...
    criterion = SeqLabelMoCoLoss(channel=channel, T=args.moco_t, device=device_name, thres=args.thres)
