...
class SeqLabelMoCo(LabelMoCo):
    def __init__(self, base_encoder, dim=128, K=65536, m=0.999, T=0.07, label_dim=10, mlp=False, ckpt=None):
        nn.Module.__init__(self)
        ...
        self.register_buffer("label", torch.zeros([K, label_dim], dtype=torch.float32))
        self.label = torch.sub(self.label, 1)
